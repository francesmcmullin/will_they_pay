...
class ReviewsTest < ApplicationSystemTestCase
  ...
  test "should create review" do
    ...
    fill_in "Plan", with: @review.plan_id
    fill_in "Provider", with: @review.provider_id
    fill_in "Result", with: @review.result_id
    fill_in "Treatment", with: @review.treatment_id
